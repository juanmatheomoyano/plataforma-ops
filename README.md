...
| **Payway** | admin, supervisor, analista | Validación de credenciales SAC + descarga masiva de reportes de transacciones como ZIP (Consolidado + IDSITES + un XLSX por seller). Jobs async con polling y barra de progreso. Estado persiste en localStorage al navegar entre módulos. Tab "Rotar contraseñas" pendiente (v2.2) |
