        ...
        <div className="space-y-4 pt-2">
          ...
          {result.errores === 0 ? (
            <div className="flex items-center gap-2 text-emerald-400">
              ...
              <span className="text-sm">Todos los sellers fueron importados correctamente.</span>
            </div>
          ) : (
                ...
                <table className="w-full text-xs text-slate-300">
                  <thead>
                    <tr className="border-b border-slate-700 bg-slate-800">
                      ...
                      <th className="px-3 py-2 text-left text-slate-500">Seller ID</th>
                  ...
                  <tbody>
                    {result.detalle_errores.map((e, i) => (
                      <tr key={i} className="border-b border-slate-700/50">
                        ...
                        <td className="px-3 py-2 text-slate-400">{e.seller_id ?? "—"}</td>
